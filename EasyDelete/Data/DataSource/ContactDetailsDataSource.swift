...
class ContactDetailsDataSource: BaseDataSource {
    ...
    private(set) var phoneNumbersData: EDTypes.ContactDetailsList = EDTypes.ContactDetailsList()
    private(set) var emailsData: EDTypes.ContactDetailsList = EDTypes.ContactDetailsList()
