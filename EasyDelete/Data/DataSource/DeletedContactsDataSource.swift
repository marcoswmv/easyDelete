...
//    
//    private(set) var data: ContactsList = ContactsList()
//    private(set) var filteredData: ContactsList = ContactsList()
...
//    }
//    
//    func deleteContact(at indexPaths: IndexPaths) {
//        var contactsToDelete = ContactsList()
//        
